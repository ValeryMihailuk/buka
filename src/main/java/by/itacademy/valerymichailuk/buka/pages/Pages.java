...
public class Pages {
    ...
    public static final String PUT_PRODUCT_IN_CARD = "//*[@class='basket-tovar-close del']";
    public static final String CHECK_PRODUCT_IN_CARD = "//div[8]/div[2][@class=\"nav-popup-body\"]";
}
