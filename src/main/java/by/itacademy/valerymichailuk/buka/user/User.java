...
public class User {
    ...
    public static final String NEW_USER_NAME = "professorfox@rambler.ru";
    public static final String NEW_USER_PASSWORD = "8GJYaJ";
    public static final String USER_NAME = "valery.mihkailuk@gmail.com";
    public static final String USER_PASSWORD = "83528352";
    public static final String INVALID_USER_NAME = "agents.paddington@gmail.com";
